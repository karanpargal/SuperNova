...
export const Hero: React.FC = () => {
  ...
  useEffect(() => {
    const handleMessage = (e: MessageEvent) => {
      if (e.origin !== `${process.env.REACT_APP_API_URL}`) return;
    ...
    <section className="w-full flex flex-col mx-auto text-center tracking-wide gap-y-10 mt-40">
      <div className="flex flex-col text-app-gray text-6xl gap-y-3 max-w-4xl mx-auto">
        <h1 className="text-gray">
          Welcome to{" "}
          <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#C0C0C0] via-[#303030] to-[#9a9a9a] animate-sparkle">
            SupraNova
          </span>
